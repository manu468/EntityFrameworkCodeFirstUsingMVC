    ...
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            viewModel.Instructors = db.Instructors
                //  The code specifies eager loading for the Instructor.OfficeAssignment and the Instructor.
                //Courses navigation property.
                 //  The second Include method loads Courses, and for each Course that is loaded it does eager loading 
                 //for the Course.Department navigation property.
        ...
        // deleted the scafolded code for http get/post for create method 
        ...
        public ActionResult Edit(int? id)
        {
            ...
            //The scaffolded code here isn't what you want. It's setting up data for a drop-down list, 
            //    but we what we need is a text box so replacing the below code 
            //Instructor instructor = db.Instructors.Find(id);
